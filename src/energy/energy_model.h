...
public:
  ...
  energy_t MismatchCoaxial(base_t fiveTop, base_t mismatch_top,
      base_t mismatch_bot, base_t threeBot) const {
    assert(IsBase(fiveTop) && IsBase(mismatch_top) && IsBase(mismatch_bot) && IsBase(threeBot));
    energy_t coax = terminal[fiveTop][mismatch_top][mismatch_bot][threeBot] +
