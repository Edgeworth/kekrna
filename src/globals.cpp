...
energy::energy_t multiloop_hack_a, multiloop_hack_b;

energy::energy_t multiloop_t99_a, multiloop_t99_b, multiloop_t99_c;

energy::energy_t dangle5_e[4][4][4];
energy::energy_t dangle3_e[4][4][4];

energy::energy_t coax_mismatch_non_contiguous, coax_mismatch_wc_bonus, coax_mismatch_gu_bonus;
